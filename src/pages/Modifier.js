			...
			<div>
				{Object.keys(modTab).map((e, i) => (
					<div className="flex flex-col" key={i}>
						{modTab[e].length > 1 &&
						modTab[e][0].affix.length > 0 &&
						(modTab[e][0].affix[0].includes(name) || name === null) ? (
